conAngular
.controller('CheckInController', ['$scope', '$rootScope', '$state', '$stateParams', 'ProjectService', 'InventoryItemService', 'BulkItemService', 'WarehouseService', 'SupplierService', 'NotificationService', 'InventoryTransactionService', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTDefaultOptions', '$location', '$filter', function( $scope, $rootScope, $state, $stateParams, ProjectService, InventoryItemService, BulkItemService, WarehouseService, SupplierService, NotificationService, InventoryTransactionService, DTOptionsBuilder, DTColumnDefBuilder, DTDefaultOptions, $location, $filter ){
  ...
  *******************/
  ...
  $scope.registerItem = function( type, itemRequestId ){
      ...
      $scope.requestEntry = function(){
          ...
          InventoryItemService.requestEntry( $scope.itemName, $scope.itemQuantity, $scope.description, $scope.itemType, $scope.selectedProject, aeId, $scope.itemState, $scope.entryDate, $scope.validityExpirationDate, function( response ){
